  ...
  <div class="row about-me">
    <h3 class="about-me-heading">Welcome to my coding project showcase!</h3>
              ...
              <p>Driven by a desire for more engaging and dynamic work, I've eagerly embraced the world of programming.
                  Equipped with a diverse skill set that includes <em>Javascript, HTML, CSS, Python, React, Express.js, NodeJs,
                  ...
                  something new as CSS can be quite daunting. After adding in backend and new features, it's been a really great learning experience. How did I do?
              </p>
